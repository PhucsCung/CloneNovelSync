...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Publisher.class.getName() + ".books", jcacheConfiguration);
            createCache(cm, com.mycompany.myapp.domain.Book.class.getName(), jcacheConfiguration);
            createCache(cm, com.mycompany.myapp.domain.Book.class.getName() + ".categories", jcacheConfiguration);
            createCache(cm, com.mycompany.myapp.domain.PurchaseOrder.class.getName(), jcacheConfiguration);
            createCache(cm, com.mycompany.myapp.domain.PurchaseOrder.class.getName() + ".lines", jcacheConfiguration);
            ...
            createCache(cm, com.mycompany.myapp.domain.SalesOrder.class.getName() + ".lines", jcacheConfiguration);
