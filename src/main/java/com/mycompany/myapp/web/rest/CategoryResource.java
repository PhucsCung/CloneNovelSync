...
public class CategoryResource {
    ...
    public ResponseEntity<CategoryDTO> createCategory(@Valid @RequestBody CategoryDTO categoryDTO) throws URISyntaxException {
        ...
        if (categoryRepository.existsByTitleIgnoreCase(categoryDTO.getTitle())) {
            throw new BadRequestAlertException("Tên thể loại này đã tồn tại trong hệ thống", ENTITY_NAME, "titleexists");
        }
