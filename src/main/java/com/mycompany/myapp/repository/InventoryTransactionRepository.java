...
public interface InventoryTransactionRepository
    ...
    @Query(
        value = "select distinct inventoryTransaction from InventoryTransaction inventoryTransaction left join fetch inventoryTransaction.book",
    ...
    @Query("select distinct inventoryTransaction from InventoryTransaction inventoryTransaction left join fetch inventoryTransaction.book")
    List<InventoryTransaction> findAllWithToOneRelationships();

    @Query(
        "select inventoryTransaction from InventoryTransaction inventoryTransaction left join fetch inventoryTransaction.book where inventoryTransaction.id =:id"
    )
