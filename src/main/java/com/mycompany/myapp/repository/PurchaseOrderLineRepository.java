...
public interface PurchaseOrderLineRepository extends JpaRepository<PurchaseOrderLine, Long> {
    ...
    @Query(
        value = "select distinct purchaseOrderLine from PurchaseOrderLine purchaseOrderLine left join fetch purchaseOrderLine.book left join fetch purchaseOrderLine.purchaseOrder",
    ...
    @Query(
        "select distinct purchaseOrderLine from PurchaseOrderLine purchaseOrderLine left join fetch purchaseOrderLine.book left join fetch purchaseOrderLine.purchaseOrder"
    )
    List<PurchaseOrderLine> findAllWithToOneRelationships();

    @Query(
        "select purchaseOrderLine from PurchaseOrderLine purchaseOrderLine left join fetch purchaseOrderLine.book left join fetch purchaseOrderLine.purchaseOrder where purchaseOrderLine.id =:id"
    )
    ...
    @Query(
        ...
        "WHERE pol.book.publisher.id = :publisherId"
    )
