...
export default class SalesOrder extends Vue {
  ...
  public retrieveAllSalesOrders(): void {
  ...
  public prepareRemove(instance: ISalesOrder): void {
  ...
  public removeSalesOrder(): void {
    this.salesOrderService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('cloneNovelSyncApp.salesOrder.deleted', { param: this.removeId });
