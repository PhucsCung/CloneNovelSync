...
export default class SalesOrderLine extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllSalesOrderLines();
  }
  ...
  public retrieveAllSalesOrderLines(): void {
  ...
  public prepareRemove(instance: ISalesOrderLine): void {
  ...
  public removeSalesOrderLine(): void {
    this.salesOrderLineService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('cloneNovelSyncApp.salesOrderLine.deleted', { param: this.removeId });
