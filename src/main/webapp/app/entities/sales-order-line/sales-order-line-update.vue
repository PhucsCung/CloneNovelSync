  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="cloneNovelSyncApp.salesOrderLine.home.createOrEditLabel"
          data-cy="SalesOrderLineCreateUpdateHeading"
          v-text="$t('cloneNovelSyncApp.salesOrderLine.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('cloneNovelSyncApp.salesOrderLine.quantity')" for="sales-order-line-quantity"
              >Quantity</label
            >
            <input
              type="number"
            ...
            <div v-if="$v.salesOrderLine.quantity.$anyDirty && $v.salesOrderLine.quantity.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.salesOrderLine.quantity.min" v-text="$t('entity.validation.min', { min: 1 })">
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('cloneNovelSyncApp.salesOrderLine.unitPrice')" for="sales-order-line-unitPrice"
              >Unit Price</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('cloneNovelSyncApp.salesOrderLine.book')" for="sales-order-line-book">Book</label>
            <select class="form-control" id="sales-order-line-book" data-cy="book" name="book" v-model="salesOrderLine.book">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="salesOrderLine.book && bookOption.id === salesOrderLine.book.id ? salesOrderLine.book : bookOption"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('cloneNovelSyncApp.salesOrderLine.salesOrder')" for="sales-order-line-salesOrder"
              >Sales Order</label
            >
            <select
              class="form-control"
