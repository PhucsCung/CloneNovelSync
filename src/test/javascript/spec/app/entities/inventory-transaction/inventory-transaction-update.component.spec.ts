...
import InventoryTransactionUpdateComponent from '@/entities/inventory-transaction/inventory-transaction-update.vue';
import InventoryTransactionClass from '@/entities/inventory-transaction/inventory-transaction-update.component';
...
describe('Component Tests', () => {
  describe('InventoryTransaction Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<InventoryTransactionClass>(InventoryTransactionUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        inventoryTransactionServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(inventoryTransactionServiceStub.update.calledWith(entity)).toBeTruthy();
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        inventoryTransactionServiceStub.retrieve.resolves([foundInventoryTransaction]);
