...
class PurchaseOrderLineResourceIT {
    ...
    public static PurchaseOrderLine createEntity(EntityManager em) {
        PurchaseOrderLine purchaseOrderLine = new PurchaseOrderLine().quantity(DEFAULT_QUANTITY).unitCost(DEFAULT_UNIT_COST);
    ...
    public static PurchaseOrderLine createUpdatedEntity(EntityManager em) {
        PurchaseOrderLine purchaseOrderLine = new PurchaseOrderLine().quantity(UPDATED_QUANTITY).unitCost(UPDATED_UNIT_COST);
        return purchaseOrderLine;
    }
    ...
    void createPurchaseOrderLine() throws Exception {
        ...
        assertThat(testPurchaseOrderLine.getUnitCost()).isEqualByComparingTo(DEFAULT_UNIT_COST);
    }
    ...
    void putExistingPurchaseOrderLine() throws Exception {
        ...
        updatedPurchaseOrderLine.quantity(UPDATED_QUANTITY).unitCost(UPDATED_UNIT_COST);
        ...
        assertThat(testPurchaseOrderLine.getUnitCost()).isEqualByComparingTo(UPDATED_UNIT_COST);
    }
    ...
    void fullUpdatePurchaseOrderLineWithPatch() throws Exception {
        ...
        partialUpdatedPurchaseOrderLine.quantity(UPDATED_QUANTITY).unitCost(UPDATED_UNIT_COST);
