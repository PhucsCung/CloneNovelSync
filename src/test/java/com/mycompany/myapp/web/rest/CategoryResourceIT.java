...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().title(DEFAULT_TITLE).desc(DEFAULT_DESC);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().title(UPDATED_TITLE).desc(UPDATED_DESC);
        return category;
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.title(UPDATED_TITLE).desc(UPDATED_DESC);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.title(UPDATED_TITLE).desc(UPDATED_DESC);
