...
class PublisherResourceIT {
    ...
    public static Publisher createEntity(EntityManager em) {
        Publisher publisher = new Publisher().code(DEFAULT_CODE).name(DEFAULT_NAME).address(DEFAULT_ADDRESS).phone(DEFAULT_PHONE);
        return publisher;
    }
    ...
    public static Publisher createUpdatedEntity(EntityManager em) {
        Publisher publisher = new Publisher().code(UPDATED_CODE).name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
        return publisher;
    }
    ...
    void createPublisher() throws Exception {
        ...
        assertThat(testPublisher.getCode()).isEqualTo(DEFAULT_CODE);
    ...
    void putExistingPublisher() throws Exception {
        ...
        updatedPublisher.code(UPDATED_CODE).name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
        ...
        Publisher testPublisher = publisherList.get(publisherList.size() - 1);
        assertThat(testPublisher.getCode()).isEqualTo(UPDATED_CODE);
    ...
    void partialUpdatePublisherWithPatch() throws Exception {
        ...
        partialUpdatedPublisher.address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    ...
    void fullUpdatePublisherWithPatch() throws Exception {
        ...
        partialUpdatedPublisher.code(UPDATED_CODE).name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
